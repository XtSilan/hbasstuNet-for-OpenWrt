...
dir /b "output\luci-app-hbasstunet_1.3.2-*.ipk" >nul 2>&1
if errorlevel 1 (
    echo Error: no version 1.3.2 IPK was produced.
    docker rm -f openwrt-builder >nul 2>&1
    exit /b 1
)
...
echo.
echo Build complete:
dir /b "output\luci-app-hbasstunet_1.3.2-*.ipk"
echo.
echo Install with:
echo   opkg install /tmp/luci-app-hbasstunet_1.3.2-*.ipk
exit /b 0
